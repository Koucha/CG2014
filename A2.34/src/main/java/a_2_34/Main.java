...
{	
	...
	static boolean keyDownW, keyDownA, keyDownS, keyDownD, fixedF;
	...
	{
		//* SWITCH
		return new TerrainRS(null, 30, 30, 6, 10, 1.5f, -0.4f, 0.5f);	// Hügelig
		/*/
		//return new TerrainRS(null, 30, 30, 20, 10, 2.0f, -0.9f, 0.57f);	// Bergig, felsig
		return new TerrainRS(null, 30, 30, 20, 10, 1.2f, -0.7f, 0.5f);		// Bergig
		// */
	}
}
