...
{	
	...
	public final static class SimpleRenderPanel extends GLRenderPanel
	{
		...
		public void init(RenderContext r)
		{
			...
			/*/
			sceneManager.setCamera(new Camera(new Vector3f(-10,40,40), new Vector3f(-5,0,0), new Vector3f(0,1,0)));
			sceneManager.setFrustum(new Frustum(1, 100, 1, 60));
			// */
			
			theThing = new HouseRS(null);
	...
	public static class AnimationTask extends TimerTask
	{
		public void run()
		{
    		...
    		Matrix4f temp = theThing.getAbsoluteTransMat();
